          ...
          <section className="max-w-xl grid place-items-center">
            <div className="w-full bg-sky-500 grid rounded-xl shadow-2xl flex p-6 m-6 gap-2">
              ...
              <div className="w-full flex justify-between">
                <div className="flex flex-col justify-between p-4 rounded-2xl shadow-md shadow-cyan-600/45">
                ...
                <div className="w-min p-4 rounded-xl shadow-md shadow-cyan-600/45">
              ...
              <div className="w-full flex justify-between">
                <div className="p-4 rounded-2xl shadow-md shadow-cyan-600/45">
              ...
              <div className="w-full p-4 rounded-2xl shadow-md shadow-cyan-600/45 justify-between">
